...
typedef int spng_read_fn(spng_ctx *ctx, void *user, void *dest, size_t size);
typedef int spng_write_fn(spng_ctx *ctx, void *user, void *src, size_t size);

typedef int spng_rw_fn(spng_ctx *ctx, void *user, void *dst_src, size_t size);
...
SPNG_API int spng_set_png_file(spng_ctx *ctx, fio_t *file);
